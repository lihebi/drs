...
{
	m_env_SIPSO = hebi::GetEnvAsInt("CHRONO_SYNC_INTEREST_PERIOD_START_OFFSET");
	m_env_SIPSF = hebi::GetEnvAsInt("CHRONO_SYNC_INTEREST_PERIOD_START_FACTOR");
	m_env_SIPO = hebi::GetEnvAsInt("CHRONO_SYNC_INTEREST_PERIOD_OFFSET");
	m_env_SIPF = hebi::GetEnvAsInt("CHRONO_SYNC_INTEREST_PERIOD_FACTOR");
	m_env_GMPSO = hebi::GetEnvAsInt("CHRONO_GEN_MESSAGE_PERIOD_START_OFFSET");
	m_env_GMPSF = hebi::GetEnvAsInt("CHRONO_GEN_MESSAGE_PERIOD_START_FACTOR");
	m_env_GMPO = hebi::GetEnvAsInt("CHRONO_GEN_MESSAGE_PERIOD_OFFSET");
	m_env_GMPF = hebi::GetEnvAsInt("CHRONO_GEN_MESSAGE_PERIOD_FACTOR");
	m_env_TW = hebi::GetEnvAsInt("CHRONO_TW");
	m_env_ILT = hebi::GetEnvAsInt("CHRONO_INTEREST_LIFE_TIME");
}
